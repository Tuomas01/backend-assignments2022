...
for (let i = 0; i < picArray.length; i++) {
  ...
  `<article><header><h2>${picArray[i].title}</h2></header><figure><img src=${picArray[i].filename} alt=${picArray[i].title} ><figcaption>${picArray[i].caption}</figcaption></figure><p>${picArray[i].description}</p></article>`;
}
